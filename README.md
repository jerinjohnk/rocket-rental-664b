...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create rocket-rental-664b
  fly apps create rocket-rental-664b-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app rocket-rental-664b
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app rocket-rental-664b-staging
  ```
...
- Create a persistent volume for the sqlite database for both your staging and
  ...
  ```sh
  fly volumes create data --size 1 --app rocket-rental-664b
  fly volumes create data --size 1 --app rocket-rental-664b-staging
  ```
